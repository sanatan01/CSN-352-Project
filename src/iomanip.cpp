...
namespace backend {
    ...
    void create_scanf_code() {
        CodeGen::add_to_asm(".globl scanf", "Make scanf function globally visible", false);
        CodeGen::add_to_asm("", "");
        CodeGen::add_to_asm("scanf:", "Start of scanf function", false);
        CodeGen::add_to_asm("move $t1, $a0", "Copy format string address to temp register");
        CodeGen::add_to_asm("li $t2, '%'", "Load comparison character '%'");
        CodeGen::add_to_asm("", "");
        CodeGen::add_to_asm("li $s0, 'c'", "Character format specifier");
        CodeGen::add_to_asm("li $s1, 'd'", "Double format specifier");
        CodeGen::add_to_asm("li $s3, 'i'", "Integer format specifier");
        CodeGen::add_to_asm("li $s4, 'f'", "Float format specifier");
        CodeGen::add_to_asm("li $s5, 0", "Initialize count of successful reads");
        CodeGen::add_to_asm("", "");
        CodeGen::add_to_asm("char_loop_scan:", "Main character processing loop", false);
        CodeGen::add_to_asm("lb $t0, ($t1)", "Load current character");
        CodeGen::add_to_asm("beqz $t0, end_scan", "Exit on null terminator");
        CodeGen::add_to_asm("beq $t0, $t2, check_specifier_scan", "Check if character is a format specifier");
        CodeGen::add_to_asm("", "");
        CodeGen::add_to_asm("addi $t1, $t1, 1", "Move to next character");
        CodeGen::add_to_asm("j char_loop_scan", "Continue loop");
        CodeGen::add_to_asm("", "");
        CodeGen::add_to_asm("check_specifier_scan:", "Process format specifier", false);
        CodeGen::add_to_asm("addi $t1, $t1, 1", "Move to next character");
        CodeGen::add_to_asm("lb $t0, ($t1)", "Load next character");
        CodeGen::add_to_asm("beqz $t0, end_scan_percent", "Exit on null terminator");
        CodeGen::add_to_asm("", "");
        CodeGen::add_to_asm("beq $t0, $s0, read_char", "Check for 'c' specifier");
        CodeGen::add_to_asm("beq $t0, $s1, read_double", "Check for 'd' specifier");
        CodeGen::add_to_asm("beq $t0, $s3, read_int", "Check for 'i' specifier");
        CodeGen::add_to_asm("beq $t0, $s4, read_float", "Check for 'f' specifier");
        CodeGen::add_to_asm("", "");
        CodeGen::add_to_asm("j char_loop_scan", "Continue processing characters");
        CodeGen::add_to_asm("", "");
        CodeGen::add_to_asm("end_scan_percent:", "Handle case where % is last character", false);
        CodeGen::add_to_asm("j end_scan", "Jump to end of function");
        CodeGen::add_to_asm("", "");
        CodeGen::add_to_asm("read_char:", "Handle character format specifier", false);
        CodeGen::add_to_asm("li $v0, 12", "Syscall 12: read character");
        CodeGen::add_to_asm("syscall", "Call system function");
        CodeGen::add_to_asm("lw $t9, ($sp)", "Load address from stack");
        CodeGen::add_to_asm("sb $v0, ($t9)", "Store character at address");
        CodeGen::add_to_asm("j update_stack", "Update stack and continue");
        CodeGen::add_to_asm("", "");
        CodeGen::add_to_asm("read_int:", "Handle integer format specifier", false);
        CodeGen::add_to_asm("li $v0, 5", "Syscall 5: read integer");
        CodeGen::add_to_asm("syscall", "Call system function");
        CodeGen::add_to_asm("lw $t9, ($sp)", "Load address from stack");
        CodeGen::add_to_asm("sw $v0, ($t9)", "Store integer at address");
        CodeGen::add_to_asm("j update_stack", "Update stack and continue");
        CodeGen::add_to_asm("", "");
        CodeGen::add_to_asm("read_float:", "Handle float format specifier", false);
        CodeGen::add_to_asm("li $v0, 6", "Syscall 6: read float");
        CodeGen::add_to_asm("syscall", "Call system function");
        CodeGen::add_to_asm("lw $t9, ($sp)", "Load address from stack");
        CodeGen::add_to_asm("swc1 $f0, ($t9)", "Store float at address");
        CodeGen::add_to_asm("j update_stack", "Update stack and continue");
        CodeGen::add_to_asm("", "");
        CodeGen::add_to_asm("read_double:", "Handle double format specifier", false);
        CodeGen::add_to_asm("li $v0, 7", "Syscall 7: read double");
        CodeGen::add_to_asm("syscall", "Call system function");
        CodeGen::add_to_asm("lw $t9, ($sp)", "Load address from stack");
        CodeGen::add_to_asm("sdc1 $f0, ($t9)", "Store double at address");
        CodeGen::add_to_asm("j update_stack", "Update stack and continue");
        CodeGen::add_to_asm("", "");
        CodeGen::add_to_asm("update_stack:", "Update stack and continue processing", false);
        CodeGen::add_to_asm("addi $sp, $sp, 4", "Adjust stack pointer");
        CodeGen::add_to_asm("addi $s5, $s5, 1", "Increment successful read count");
        CodeGen::add_to_asm("addi $t1, $t1, 1", "Move to next character");
        CodeGen::add_to_asm("j char_loop_scan", "Continue processing characters");
        CodeGen::add_to_asm("", "");
        CodeGen::add_to_asm("end_scan:", "End of scanf function", false);
        CodeGen::add_to_asm("move $v0, $s5", "Return number of successful reads");
        CodeGen::add_to_asm("jr $ra", "Return to caller");
        CodeGen::add_to_asm("", "");
    }
}